...
function App() {
  ...
  return (
    <>
    <div id='header' className='bg-green-500 text-white mb-3 sticky top-0 w-full h-15 flex justify-between'>
      <h1 className='flex pl-2 items-center font-bold text-4xl'>JOB.SCRAPER</h1>
